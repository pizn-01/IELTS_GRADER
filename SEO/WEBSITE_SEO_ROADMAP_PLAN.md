# Website SEO Roadmap Plan (SEO Lead brief)

**Status:** Executed — living roadmap published  
**Sources:** `/Users/amir/Downloads/seo.docx` · site inventory · weak-SEO diagnosis · flywheel · SEO-lead review  
**Updated:** 2026-08-03  
**Published outputs:**
- [WEBSITE_SEO_ROADMAP.md](WEBSITE_SEO_ROADMAP.md)
- [WEBSITE_SEO_ROADMAP.pdf](WEBSITE_SEO_ROADMAP.pdf)
- Script: `SEO/scripts/generate_website_seo_roadmap_pdf.py`
- Cross-links: README, CONTENT_CALENDAR (Phase 3), KEYWORDS

**Canonical host:** `https://www.ieltsgrader.com`  
**Product:** IELTS AI Tutor by IELTSGRADER  

**Also in Cursor:** `.cursor/plans/seo_roadmap_publish_7bab6664.plan.md`
...
1. Write `SEO/WEBSITE_SEO_ROADMAP.md` with diagnosis, flywheel rules, per-URL strategy, update/create queues, 12-week timeline
2. Add `generate_website_seo_roadmap_pdf.py` → `SEO/WEBSITE_SEO_ROADMAP.pdf`
3. Update `SEO/README.md`, `CONTENT_CALENDAR.md`, `KEYWORDS.md` to point at roadmap queue

---

## Deliverable

Create **SEO/WEBSITE_SEO_ROADMAP.md** + **SEO/WEBSITE_SEO_ROADMAP.pdf** (same pattern as cadence).

Also:
- Link from `SEO/README.md` as the **content/strategy roadmap**
- Refresh `CONTENT_CALENDAR.md` + `KEYWORDS.md` with Phase 3 queue
- Keep `WEBSITE_SEO_CADENCE.md` as daily/weekly/monthly ops (titles, links, GSC)
- Reuse/adapt `SEO/scripts/generate_website_seo_cadence_pdf.py`

Execution of this plan ships the **roadmap document only** — not the blog posts themselves.
...
| Weeks | Focus | Ship |
|-------|--------|------|
| **0–1** | **Foundation gate** | Verify GSC **www**; submit sitemap; request indexing for `/`, `/ielts-essay-checker`, `/ielts-ai-tutor`, `/blog`, top posts; confirm prod prerender HTML; align robots/sitemap/canonicals to www; fix sitemap generator drift (`/features`, `/sample-report`); Bing Webmaster (import from GSC) + IndexNow; start Mon GSC scorecard |
| **1–2** | P0 polish + E-E-A-T + Wave A start | Meta/FAQ/CTA on `/`, checker, AI tutor, band-score; **E-E-A-T ship: author byline + profile, methodology page, last-updated dates, breadcrumbs/Organization schema**; publish 5–6 Wave A Q&A snippet posts first (fastest to rank: word count, paragraphs, idioms, "I", timing); refresh plateau + band-6-vs-7; CWV pass on P0; decide claims (keep/soften/prove) |
| **3–4** | Wave A finish + tool depth + first data study | Remaining Wave A (ChatGPT cluster + structure + 7→8) with FAQ schema; deepen Task 1/2 checker + mock; internal link audit; band score **calculator widget** live; start data study #2 (ChatGPT vs us vs examiner) collection; first off-site action |
| **5–6** | Wave B essay types + data study publish | 5 essay-type templates + types hub + TR + GRA errors; publish accuracy data study + pitch to communities; homepage "latest from the blog" section for crawl paths |
...
## Implementation steps (when executing this plan)

1. Write `SEO/WEBSITE_SEO_ROADMAP.md` with Parts A–F above (diagnosis + risk register, competitive reality + SERP recon rule, flywheel + B4 quality bar, URL improve matrix + C6 decision rules, create queues + D9 data moat, corrected-velocity 12-week calendar, leading KPIs + competitor tracking).  
2. Add `SEO/scripts/generate_website_seo_roadmap_pdf.py` and generate the PDF.  
3. Update `SEO/README.md`, `CONTENT_CALENDAR.md` (Phase 3 queue), `KEYWORDS.md` (new targets → planned slugs).  
4. Do **not** create blog markdown posts in that execution — roadmap publish only.  
5. Mark risk-register items closed in roadmap as You/Agent complete them over the 12 weeks.
