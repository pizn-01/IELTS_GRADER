...
| **3–4** | Wave A finish + tool depth + first data study | Remaining Wave A (ChatGPT cluster + structure + 7→8) with FAQ schema; deepen Task 1/2 checker + mock; internal link audit; band score **calculator widget** live; start data study #2 (ChatGPT vs us vs examiner) collection; first off-site action | **Nearly done (4 Aug 2026):** Wave A + tools + calculator + internal-link audit **done**. Off-site draft ready (you post). Data study protocol ready (collection open). → `SEO/NEXT_SESSION.md` |
| **5–6** | Wave B essay types + data study publish | 5 essay-type templates + types hub + TR + GRA errors; publish accuracy data study + pitch to communities; homepage "latest from the blog" section for crawl paths | **Partial (4 Aug 2026):** hub + 5 templates + TR/GRA + homepage latest **done**. Data study publish still blocked on corpus. |
