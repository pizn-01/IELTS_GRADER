...
| **5–6** | Wave B essay types + data study publish | 5 essay-type templates + types hub + TR + GRA errors; publish accuracy data study + pitch to communities; homepage "latest from the blog" section for crawl paths | **Not started** — after Week 3–4 leftovers |
