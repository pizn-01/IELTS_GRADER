          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-3">
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="flex items-center gap-2 cursor-pointer group min-w-0">
                <h1 className="text-[18px] md:text-[22px] font-bold text-[#101828] tracking-tight truncate">{activeTask}</h1>
                <ChevronDown size={20} className="text-[#101828] shrink-0" />
              </div>
            </div>
            <button className="w-full md:w-auto px-5 h-[40px] bg-[#2C3E50] text-white rounded-[10px] text-[13px] font-semibold hover:bg-[#1D2939] transition-all shadow-sm">
              Export Report
            </button>
          </div>
