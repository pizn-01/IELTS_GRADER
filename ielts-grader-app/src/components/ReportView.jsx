...
import { ChevronDown, ChevronRight, FileText, Download, Eye, ArrowLeft, CheckCircle, XCircle, AlertTriangle, TrendingDown, X, Bell, User, Shield, CircleDollarSign, HelpCircle, LogOut, Info } from 'lucide-react';
      ...
      <div className="relative z-10 overflow-hidden" style={{
        ...
        <div className="max-w-[1340px] mx-auto px-[50px] pt-12 relative z-20">
          ...
          <div className="flex items-center gap-[28px] border-b border-[#D1D5DB66]">
            {((data?.taskType === 'Task 2' || taskTitle.includes('Task 2'))
          ...
          <div className="space-y-6">
            {!taskTitle.includes('Task 2') ? (
              ...
              <div className="space-y-6">
                {/* Top Stats Bar */}
                {/* Top Stats Bar */}
                <div className="bg-white rounded-[20px] border border-[#E5E7EB] shadow-sm flex items-center h-[120px]">
                  {/* Latest Band */}
                ...
                <div className="grid grid-cols-4 gap-6">
                  {/* Activity Profile */}
                  <div className="bg-white rounded-[16px] border border-[#E5E7EB] shadow-sm flex flex-col h-full overflow-hidden hover:shadow-md transition-shadow">
                    <div className="px-8 py-5 border-b border-[#F2F4F7]">
                      <h3 className="text-[16px] font-bold text-[#101828]">Activity Profile</h3>
                    </div>
                  ...
                  {/* Executive Summary */}
                  <div className="col-span-2 bg-white rounded-[16px] border border-[#E5E7EB] shadow-sm flex flex-col overflow-hidden hover:shadow-md transition-shadow">
                    <div className="px-8 py-5 border-b border-[#F2F4F7]">
                      <h3 className="text-[16px] font-bold text-[#101828]">Executive Summary</h3>
                    </div>
                    <div className="p-8 space-y-10 flex-1">
                  ...
                  <div className="bg-white rounded-[16px] border border-[#E5E7EB] shadow-sm flex flex-col h-full overflow-hidden hover:shadow-md transition-shadow">
                    ...
                    <div className="p-8 space-y-5 flex-1">
                      <div className="p-5 bg-[#F0FDF9] rounded-[16px] border border-[#CCFBEF] flex items-center">
                ...
                <div className="grid grid-cols-4 gap-6">
                  {/* Skill Growth */}
                  <div className="col-span-3 bg-white rounded-[16px] border border-[#00000026] shadow-sm p-8 h-[400px] flex flex-col">
                    <h3 className="text-[14px] font-bold text-[#101828] mb-6">Skill Growth</h3>
                    <div className="flex-1 bg-[#F8FAFC] rounded-[12px] border border-dashed border-gray-200 flex items-center justify-center relative overflow-hidden">
                      <svg className="w-full h-full p-4" viewBox="0 0 800 300">
                        <path d="M0,200 Q100,150 200,220 T400,180 T600,240 T800,160" fill="none" stroke="#3B82F6" strokeWidth="3" />
                        <path d="M0,220 Q100,170 200,240 T400,200 T600,260 T800,180" fill="none" stroke="#F59E0B" strokeWidth="3" />
                        <path d="M0,240 Q100,190 200,260 T400,220 T600,280 T800,200" fill="none" stroke="#00C9B1" strokeWidth="3" />
                        <path d="M0,180 Q100,130 200,200 T400,160 T600,220 T800,140" fill="none" stroke="#8B5CF6" strokeWidth="3" />
                      </svg>
                      <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-6">
                        {[{ label: "Overall Band", color: "bg-[#EF4444]" }, { label: "Task Response", color: "bg-[#F59E0B]" }, { label: "Coherence", color: "bg-[#00C9B1]" }, { label: "Vocabulary", color: "bg-[#8B5CF6]" }, { label: "Grammar", color: "bg-[#3B82F6]" }].map((item, i) => (
                          <div key={i} className="flex items-center gap-2">
                            <div className={`w-2 h-2 rounded-full ${item.color}`}></div>
                             <span className="text-[10px] font-bold text-[#101828]">{item.label}</span>
                          </div>
                        ))}
                      </div>
                    </div>
                  ...
                  {/* Mistakes Frequency */}
                  <div className="bg-white rounded-[16px] shadow-sm border border-[#E5E7EB] flex flex-col overflow-hidden">
                    <div className="px-8 py-4 border-b border-[#F2F4F7]">
                      <h3 className="text-[14px] font-bold text-[#101828]" style={{ fontFamily: "'Nunito', sans-serif" }}>Mistakes Frequency</h3>
                    </div>
                    
                    <div className="p-6 flex-1 flex flex-col">
                      {/* Stats Bar */}
                      <div className="bg-[#F9FAFB] rounded-[10px] p-2.5 flex items-center justify-between mb-3">
                        <span className="text-[12px] font-semibold text-[#475467]" style={{ fontFamily: "'Nunito', sans-serif" }}>
                          Total Instances: <span className="text-[#101828] font-bold">30</span>
                        </span>
                        <span className="text-[12px] font-semibold text-[#475467]" style={{ fontFamily: "'Nunito', sans-serif" }}>
                          Unique Types: <span className="text-[#101828] font-bold">20</span>
                        </span>
                      </div>
                      ...
                      <div className="space-y-0 flex-1">
                        {[
                          { label: "Repetition of Basic Lexis", count: "10", type: "red" },
                          { label: "Imprecise Word Choice", count: "08", type: "red" },
                          { label: "Ideas Underdeveloped", count: "07", type: "yellow" },
                          { label: "Unclear Referencing", count: "03", type: "yellow" },
                          { label: "Logical Progression Gap", count: "02", type: "gray" }
                        ].map((item, index) => {
                          const colors = {
                          ...
                          return (
                            <div key={index} className={`flex items-center justify-between py-2.5 ${index !== 4 ? 'border-b border-[#F2F4F7]' : ''}`}>
                              <span className={`px-3 py-1 rounded-full border text-[11px] font-bold ${colors[item.type]}`} style={{ fontFamily: "'Nunito', sans-serif" }}>
                                {item.label}
                              </span>
                              <span className="px-3 py-1 bg-[#1018280D] rounded-full text-[11px] font-bold text-[#101828]" style={{ fontFamily: "'Nunito', sans-serif" }}>
                                Count: {item.count}
                              </span>
                            </div>
                          );
                      ...
                      <button className="text-[13px] font-bold text-[#101828] mt-3 hover:text-gray-600 transition-colors" style={{ fontFamily: "'Nunito', sans-serif" }}>
                        Load more...
                      </button>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-4 gap-6">
                  ...
                  <div className="col-span-3 grid grid-cols-2 gap-6">
                    {[
                      { title: "Task Response", first: "6.0", latest: "7.0", growth: "+1.0" },
                      { title: "Coherence", first: "6.5", latest: "7.5", growth: "+1.0" },
                      { title: "Lexical Resource", first: "6.0", latest: "7.0", growth: "+1.0" },
                      { title: "Grammatical", first: "5.5", latest: "6.5", growth: "+1.0" }
                    ].map((card, i) => (
                      <div key={i} className="bg-white rounded-[16px] shadow-sm border border-[#E5E7EB] hover:shadow-md transition-shadow overflow-hidden flex flex-col">
                        <div className="px-6 py-4 border-b border-[#F2F4F7]">
                          <h3 className="text-[14px] font-bold text-[#101828]" style={{ fontFamily: "'Nunito', sans-serif" }}>{card.title}</h3>
                        </div>
                        <div className="p-6 space-y-2 flex-1">
                          <div className="flex items-center justify-between py-0">
                            <span className="text-[15px] font-semibold text-[#101828]" style={{ fontFamily: "'Nunito', sans-serif", lineHeight: '100%' }}>First</span>
                            <span className="text-[14px] font-bold text-gray-400" style={{ fontFamily: "'Nunito', sans-serif" }}>{card.first}</span>
                          </div>
                          <div className="flex items-center justify-between py-0">
                            <span className="text-[15px] font-semibold text-[#101828]" style={{ fontFamily: "'Nunito', sans-serif", lineHeight: '100%' }}>Latest</span>
                            <span className="text-[16px] font-normal text-[#101828B2]" style={{ fontFamily: "'Nunito', sans-serif" }}>{card.latest}</span>
                          </div>
                          <div className="flex items-center justify-between py-0">
                            <span className="text-[15px] font-semibold text-[#101828]" style={{ fontFamily: "'Nunito', sans-serif", lineHeight: '100%' }}>Growth</span>
                            <div className="bg-[#F0FDF9] text-[#30C3A9] px-3 py-1 rounded-full text-[12px] font-bold border border-[#30C3A980]" style={{ fontFamily: "'Nunito', sans-serif" }}>
                              {card.growth}
                            </div>
                          </div>
                        </div>
                  ...
                  {/* High-Impact Areas */}
                  <div className="bg-white rounded-[16px] border border-[#00000026] shadow-sm p-8 flex flex-col">
                    <h3 className="text-[14px] font-bold text-[#101828] mb-6">High-Impact Areas to Fix</h3>
                    <div className="space-y-4 flex-1">
                      {[
                        { label: "Repetition of basic lexis", impact: "High Impact", color: "text-[#EF4444] border-[#EF4444] bg-[#FFF5F5]" },
                        { label: "Imprecise word choice", impact: "High Impact", color: "text-[#EF4444] border-[#EF4444] bg-[#FFF5F5]" },
                        { label: "Ideas underdeveloped", impact: "Medium Impact", color: "text-[#F59E0B] border-[#F59E0B] bg-[#FFFBEB]" }
                      ].map((item, i) => (
                        <div key={i} className="flex items-center justify-between">
                          <span className="text-[11px] font-medium text-[#475467]">{item.label}</span>
                          <span className={`text-[8px] font-bold px-2 py-1 rounded-full border ${item.color}`}>{item.impact}</span>
                        </div>
                      ))}
                    </div>
                    <button className="text-[11px] font-bold text-gray-400 mt-4">Load more...</button>
                  </div>
                </div>
              </div>
            ) : (
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="bg-white rounded-[16px] border border-gray-100 shadow-sm overflow-hidden">
                    <div className="px-8 py-6 border-b border-gray-100"><h3 className="text-[16px] font-bold text-[#101828]">Strengths</h3></div>
                    <div className="p-8"><ul className="space-y-5">{["Clear introduction identifying chart type and subject", "Logical body structure organized by age group", "Effective use of cohesive devices and linking words", "Good paragraphing with unified topic focus"].map((text, i) => (<li key={i} className="flex items-start gap-4"><div className="mt-1 text-[#00C9B1]"><CheckCircle size={20} /></div><span className="text-[14px] text-[#101828] font-semibold leading-relaxed">{text}</span></li>))}</ul></div>
                  </div>
                  <div className="bg-white rounded-[16px] border border-gray-100 shadow-sm overflow-hidden">
                    <div className="px-8 py-6 border-b border-gray-100"><h3 className="text-[16px] font-bold text-[#101828]">Weaknesses</h3></div>
                    <div className="p-8"><ul className="space-y-5">{["Data accuracy issues — numerical values don't match reference", "Coverage gaps — misses key features from the reference chart", "Limited sentence variety (predominantly simple/compound)", "Basic comparative phrasing rather than precise quantified comparisons"].map((text, i) => (<li key={i} className="flex items-start gap-4"><div className="mt-1 text-[#FF4D4D]"><AlertTriangle size={20} /></div><span className="text-[14px] text-[#101828] font-semibold leading-relaxed">{text}</span></li>))}</ul></div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="bg-white rounded-[16px] border border-gray-100 shadow-sm overflow-hidden">
                    <div 
                      ...
                      onClick={() => toggleSection('taskResponse')}
                    >
                      <div className="flex items-center gap-4">
                        <span className="text-[16px] font-bold text-[#101828]">Task Response</span>
                        <span className="inline-flex items-center justify-center bg-[#E6FFFA] text-[#00C9B1] border border-[#B2F5EA] text-[12px] font-bold px-4 py-1.5 rounded-full uppercase leading-none">Band 7</span>
                      </div>
                      <ChevronDown size={20} className={`text-gray-400 transition-transform duration-300 ${expandedSections.taskResponse ? "rotate-180" : ""}`} />
                    </div>
                    {expandedSections.taskResponse && (
                      <div className="border-t border-gray-100 animate-in fade-in slide-in-from-top-2 duration-200">
                        {[
                          { label: "Coverage", score: "4.0", text: "Both views and the writer's opinion are addressed, but the response lacks sufficient detail in some areas.", style: "bg-[#FFF5F5] text-[#EA4335] border-[#EA4335]" },
                          { label: "Position", score: "5.0", text: "Opinion is clear and maintained throughout, though some arguments could be more fully developed.", style: "bg-[#FFF7ED] text-[#F59E0B] border-[#F59E0B]" }
                        ].map((item, i) => (
                          <div key={i} className="px-8 py-5 border-b border-gray-100 last:border-0">
                            <div className="flex items-center gap-3 mb-2">
                              <span className="text-[14px] font-semibold text-[#101828]">{item.label}</span>
                              <span className={`${item.style} inline-flex items-center justify-center border-[1.5px] text-[12px] font-bold px-4 py-1.5 rounded-full uppercase leading-none`}>Band {item.score}</span>
                            </div>
