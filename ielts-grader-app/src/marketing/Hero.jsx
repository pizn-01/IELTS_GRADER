            ...
            {cardView === 'default' ? (
              <div className="flex-1 flex flex-col animate-fadeIn">
                ...
                <div 
                  ...
                  className={`group border rounded-[12px] py-5 px-3.5 min-h-[84px] lg:min-h-0 lg:p-5 mb-3 lg:mb-3 cursor-pointer transition-all active:scale-[0.98] active:bg-[#F8FAFC] relative bg-white flex items-center gap-3.5 text-left lg:flex-col lg:text-center lg:gap-0 ${
                ...
                <div 
                  ...
                  className={`group border rounded-[12px] py-5 px-3.5 min-h-[84px] lg:min-h-0 lg:p-5 mb-0 lg:mb-3 cursor-pointer transition-all active:scale-[0.98] active:bg-[#F8FAFC] relative bg-white flex items-center gap-3.5 text-left lg:flex-col lg:text-center lg:gap-0 ${
                    selectedOption === 'mock' 
                      ? 'border-[#3B82F6] shadow-[0_0_0_3px_rgba(59,130,246,0.08)]' 
                      : 'border-[#E8ECF1] hover:border-[#3B82F6] hover:shadow-[0_0_0_3px_rgba(59,130,246,0.08)]'
                  }`}
