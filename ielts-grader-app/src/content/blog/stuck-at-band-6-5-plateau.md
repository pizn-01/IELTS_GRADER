...
### 1. Overall-score obsession

Checking daily hoping for a lucky 7 teaches nothing. Track the target criterion instead.

### 2. Strategy hopping

Monday: fancy introductions. Tuesday: idiom lists. Wednesday: new template. Nothing compounds.

### 3. Passive input only

Reading model essays without rewriting your own scripts feels productive and changes little.

### 4. Ignoring Task 1

Essay improvements cannot fully rescue Writing if Task 1 TA is weak. Module guide: [Academic vs GT](/blog/academic-vs-general-training-writing).
...
### If Coherence is the cap

Use [14-day CC plan](/blog/coherence-cohesion-14-day-plan): topic sentences, one idea per paragraph, referencing.
...
Collocations and controlled paraphrase: [LR Band 6→7](/blog/lexical-resource-band-6-to-7).
...
Overviews or letter bullets: [trends vocab](/blog/task-1-trends-vocabulary), [bar chart sample](/blog/task-1-bar-chart-band-7), [letter checklist](/blog/gt-formal-letter-checklist).

## What “progress” looks like before overall 7
...
| Week | Action |
|------|--------|
| 1 | Mock + choose theme + start sprint |
| 2 | Finish 14-day sprint + mid-checks |
| 3 | Retest mock; if theme improved, start next lowest criterion |
| 4 | Mixed practice + final mock; decide if another month is needed |

Plan intensity: [practice plans explained](/blog/ielts-writing-practice-plans-explained), [pricing](/pricing), [free vs paid](/blog/free-vs-paid-ielts-checker).
