...
[IELTS AI Tutor](/ielts-ai-tutor) evaluates vocabulary, grammar, coherence, and task fulfilment based on the text it receives. If OCR misreads *their* as *there*, or drops a whole line, you may see:
...
Fix the capture first; then trust the [essay checker](/ielts-essay-checker) notes.
...
Then upload for feedback using the checklist above. Pair with [mock writing practice](/blog/ielts-mock-writing-practice-guide).
...
4. Submit to [essay checker](/ielts-essay-checker) or [Task 2 checker](/ielts-task-2-checker).  
5. Build drills from real criterion notes ([feedback to study plan](/blog/feedback-to-study-plan)).  
