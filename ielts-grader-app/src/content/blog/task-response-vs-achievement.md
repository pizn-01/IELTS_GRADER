...
1. A clear **overview** of main trends/features  
2. Accurate reporting of key data  
3. Relevant **comparisons**  
4. No inappropriate opinion or speculation  
...
Model: [Band 7 bar chart](/blog/task-1-bar-chart-band-7). Language support: [trends vocabulary](/blog/task-1-trends-vocabulary).
...
1. Clear purpose  
2. Coverage of **all bullet points** with enough detail  
3. Appropriate **tone** for the recipient  
...
Tools: [formal letter checklist](/blog/gt-formal-letter-checklist), [Band 8 complaint sample](/blog/gt-letter-sample-band-8-complaint).
...
Band contrast: [Band 6 vs 7 Task 2](/blog/band-6-vs-7-task-2). Samples: [Band 7 technology](/blog/task-2-sample-band-7-technology), [Band 7.5 opinion](/blog/task-2-opinion-essay-band-7-5).
...
Your tutor report should label them correctly by task type. If you are choosing modules, read [Academic vs GT writing](/blog/academic-vs-general-training-writing).
...
- 1 timed Task 1  
- Check with [essay checker](/ielts-essay-checker)  
...
- 1 timed Task 2 via [Task 2 checker](/ielts-task-2-checker)  
