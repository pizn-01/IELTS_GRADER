  ...
  return (
    <>
      <SeoHead
        ...
        description="Paste or upload your IELTS essay for criterion scores, sentence-level fixes, and a personalized plan toward your target band. 2 free evaluations. No card required."
        path="/grade-my-essay"
      />
