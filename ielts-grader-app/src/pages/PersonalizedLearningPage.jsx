...
export default function PersonalizedLearningPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-56px)] lg:h-[calc(100vh-56px)] flex flex-col lg:overflow-hidden">
      {/* Hero — compact */}
      ...
      {/* Main canvas */}
      <div className="flex-1 flex flex-col max-w-[1440px] mx-auto w-full px-4 md:px-6 py-3 lg:min-h-0 lg:overflow-hidden">
        {error && (
        ...
        {loading ? (
          ...
          <div className="bg-[#F4F6F8] rounded-[20px] border border-[#E5E7EB]/80 p-3 md:p-4 flex flex-col flex-1 lg:min-h-0 gap-3 lg:overflow-hidden">
            {/* Edition pills */}
